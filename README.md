...
```text
Install Project Context v0.1.4 into the current repository.
...
2. Download these assets for tag v0.1.4 into a private temporary directory:
   - https://github.com/k2nr/project-context-skill/releases/download/v0.1.4/project-context-skill-v0.1.4.tar.gz
   - https://github.com/k2nr/project-context-skill/releases/download/v0.1.4/project-context-skill-v0.1.4.tar.gz.sha256
3. Verify the archive with `sha256sum -c project-context-skill-v0.1.4.tar.gz.sha256` or `shasum -a 256 -c project-context-skill-v0.1.4.tar.gz.sha256`. Stop if verification fails.
4. If `gh` already exists, also run `gh attestation verify project-context-skill-v0.1.4.tar.gz --repo k2nr/project-context-skill`. Stop if this verification fails. Do not install `gh` solely for this step; report that attestation verification was unavailable and continue with the checksum when `gh` is absent.
