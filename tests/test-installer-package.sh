...
"${repository_root}/bin/package-installer" 0.3.0 "$first" >/dev/null
"${repository_root}/bin/package-installer" 0.3.0 "$second" >/dev/null
asset=install-project-context-v0.3.0
