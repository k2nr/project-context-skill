...
"${repository_root}/bin/package-installer" 0.4.0 "$first" >/dev/null
"${repository_root}/bin/package-installer" 0.4.0 "$second" >/dev/null
asset=install-project-context-v0.4.0
