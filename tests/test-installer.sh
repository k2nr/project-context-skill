...
"${repository_root}/bin/package-installer" 0.4.0 "${release_root}/v0.4.0" >/dev/null
installer_under_test="${release_root}/v0.4.0/install-project-context-v0.4.0"
...
binary="${release_root}/v0.4.0/project-context-v0.4.0-${target_arch}-${target_system}"
...
printf '%064d  unexpected-file\n' 0 \
  > "${bad_release}/v0.4.0/project-context-skill-v0.4.0.tar.gz.sha256"
